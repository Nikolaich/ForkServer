...
var URL = map[string]tengo.Object{
	...
	"resolve": &tengo.UserFunction{Name: "resolve", Value: resolve},
}
...
func resolve(args ...tengo.Object) (ret tengo.Object, err error) {
	if len(args) != 2 {
		err = tengo.ErrWrongNumArguments
	} else if bo, o := args[0].(*tengo.String); !o {
		err = tengo.ErrInvalidArgumentType{Name: "first", Expected: "string", Found: args[0].TypeName()}
	} else if ro, o := args[1].(*tengo.String); !o {
		err = tengo.ErrInvalidArgumentType{Name: "first", Expected: "string", Found: args[1].TypeName()}
